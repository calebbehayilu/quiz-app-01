const Result = ({result , onShowModal}) => {
  ...
  return (
    <div className=" bg-opacity-70 bg-background overflow-hidden justify-center items-center flex 
          ...
          <div className="relative w-auto my-6 mx-auto max-w-3xl">
            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-primary outline-none focus:outline-none">
              ...
              <div className="flex items-center justify-end p-6 border-t border-solid border-slate-200 rounded-b">
                <button
                  className=" rounded-lg bg-secondary text-textColor background-transparent font-bold uppercase px-6
